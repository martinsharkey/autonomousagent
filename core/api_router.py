...
class LLMProviderPool:
    ...
    def _get_least_cooled_provider(self) -> Optional[Dict]:

        """Fallback: return the provider with the soonest cooldown expiry."""
    ...
    def _select_provider(self) -> Optional[Dict]:
        ...
        if not active:
            ...
            fallback = self._get_least_cooled_provider()

            if fallback:

                print(f"[API ROUTER] All providers in cooldown, using least-cooled: {fallback['name']}")
