"""
sentiment_analyzer - Autonomous Council Microservice
...
# Configuration
NODE_ID = os.getenv("NODE_ID", f"sentiment_analyzer-{uuid.uuid4().hex[:8]}")
COUNCIL_URL = os.getenv("COUNCIL_URL", "http://localhost:8000")
SHARED_SECRET = os.getenv("SHARED_SECRET", "")
PORT = int(os.getenv("PORT", "8000"))

app = FastAPI(title="sentiment_analyzer", version="1.0.0")
...
try:
    from deploy.components.sentiment_analyzer.component import analyze_sentiment as _component_func
